...
class MCToolbox:
    def __init__(self, root):
        ...
        if not self.is_admin():
            messagebox.showwarning("权限警告", "未以管理员权限运行，热键功能可能无法正常工作。\n请右键点击程序并选择'以管理员身份运行'。")
    ...
    def create_summon_tab(self):
        ...
        self.creature_var = tk.StringVar(value=list(self.creatures.keys())[0])
        ...
        # 显示生物ID
        self.creature_id_var = tk.StringVar(value=self.creatures[self.creature_var.get()])
